...
const ProductDetailPage: React.FC = () => {
  ...
  const getProductImages = () => {
    ...
    return images.length > 0 ? images : ['/src/assets/images/placeholder.jpg'];
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="aspect-square rounded-2xl overflow-hidden bg-white shadow-lg">
              <img
                src={imageErrors.has(selectedImageIndex) ? '/src/assets/images/placeholder.jpg' : productImages[selectedImageIndex]}
                alt={product.name}
            ...
            {productImages.length > 1 && (
              <div className="grid grid-cols-4 gap-4">
                {productImages.map((image, index) => (
                  ...
                  >
                    <img
                      src={imageErrors.has(index) ? '/src/assets/images/placeholder.jpg' : image}
          ...
          <div className="space-y-6">
            ...
            {!isOutOfStock && (
              <div className="space-y-4">
                {/* Quantity */}
                <div className="flex items-center space-x-4">
                  <label className="font-medium text-gray-900">Số lượng:</label>
                ...
                <div>
                  <button
                    ...
                    className="w-full bg-amber-600 text-white px-6 py-3 rounded-lg hover:bg-amber-700 transition-colors font-medium flex items-center justify-center space-x-2"
                  >
