  ...
  const bannerSlides = [
    {
      ...
      description: "Khám phá bộ sưu tập xì gà Cuba cao cấp với chất lượng đảm bảo 100%"
    },
    {
      id: 2,
      ...
      description: "Trải nghiệm những sản phẩm thủ công tinh xảo từ các nghệ nhân hàng đầu"
    },
    {
      id: 3,
      ...
      description: "Sự kết hợp hoàn hảo giữa whisky thượng hạng và xì gà Cuba chính hãng"
    }
  ];
  ...
  <div>
    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-20">
        <div className="absolute top-20 left-20 w-8 h-8 rounded-full bg-gray-300 opacity-30 floating-smoke floating-smoke-1"></div>
        <div className="absolute top-40 right-32 w-6 h-6 rounded-full bg-gray-400 opacity-20 floating-smoke floating-smoke-2"></div>
        <div className="absolute top-60 left-1/3 w-10 h-10 rounded-full bg-gray-200 opacity-25 floating-smoke floating-smoke-3"></div>
        <div className="absolute top-80 right-20 w-4 h-4 rounded-full bg-gray-300 opacity-15 floating-smoke floating-smoke-4"></div>
      </div>

      {/* Golden Particles */}
      <div className="absolute inset-0 pointer-events-none z-10">
        <div className="absolute bottom-20 left-10 w-2 h-2 rounded-full bg-amber-400 golden-particles particle-1"></div>
        <div className="absolute bottom-32 left-32 w-1 h-1 rounded-full bg-amber-500 golden-particles particle-2"></div>
        <div className="absolute bottom-40 left-20 w-3 h-3 rounded-full bg-amber-300 golden-particles particle-3"></div>
        <div className="absolute bottom-28 left-40 w-1 h-1 rounded-full bg-amber-600 golden-particles particle-4"></div>
        <div className="absolute bottom-50 left-16 w-2 h-2 rounded-full bg-amber-400 golden-particles particle-5"></div>
      </div>
      ...
      <div className="relative w-full h-full">
        ...
        {bannerSlides.map((slide, index) => (
          ...
          >
            ...
            {/* Rotating Cigar Ring Background */}
            <div className="absolute top-1/4 right-10 opacity-10">
              <div className="w-96 h-96 border-4 border-amber-500 rounded-full cigar-ring"></div>
            </div>

            {/* Content Overlay */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white max-w-5xl mx-auto px-4 relative">
                {/* Main Title with Luxury Effect */}
                <h1 className="text-8xl font-bold mb-6 tracking-wide luxury-text-reveal cigar-glow relative">
                  {slide.title}
                  <div className="absolute -top-4 -right-4 w-8 h-8">
                    <GiCigar className="text-2xl text-amber-400 floating-smoke" />
                  </div>
                </h1>

                {/* Subtitle with Shimmer */}
                <h2 className="text-4xl font-light mb-8 text-amber-300 animate-fade-in-up animation-delay-200 luxury-shimmer">
                  {slide.subtitle}
                </h2>

                {/* Description with Fade */}
                <p className="text-xl mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400 text-gray-100">
                  {slide.description}
                </p>

                {/* Premium Buttons */}
                <div className="flex justify-center space-x-8 animate-fade-in-up animation-delay-600">
                  <button className="btn-luxury text-black px-12 py-5 rounded-full font-bold text-xl transition-all duration-500 transform hover:scale-110 shadow-2xl relative overflow-hidden">
                    <span className="relative z-10">Khám Phá Ngay</span>
                  </button>
                  <button className="border-3 border-amber-400 text-white px-12 py-5 rounded-full font-bold text-xl hover:bg-amber-400 hover:text-black transition-all duration-500 transform hover:scale-110 flex items-center premium-hover cigar-glow">
                ...
                <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2 opacity-30">
                  <div className="flex space-x-4">
                    ...
                    <GiCigar className="text-4xl text-amber-400 cigar-ring" style={{animationDelay: '10s'}} />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Khám phá những dòng xì gà cao cấp được tuyển chọn kỹ lưỡng từ các vùng đất nổi tiếng trên thế giới
          </p>
            ...
            {categories.map((category, index) => {
              return (
                <Link
                  ...
                  className={`group relative block premium-card-entrance category-stagger-${index + 1}`}
                >
                      ...
                      <div className="space-y-4">
                        ...
                        {category.description ? (
                          ...
                          <p className="text-gray-300 text-sm leading-relaxed">
                            Khám phá bộ sưu tập {category.name.toLowerCase()} cao cấp với chất lượng đỉnh cao
                          </p>
                        )}
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-amber-500/30">
                          ...
                          <div className="w-8 h-8 bg-amber-500/20 rounded-full flex items-center justify-center group-hover:bg-amber-500 transition-colors duration-300">
                            <span className="text-amber-400 group-hover:text-black transition-colors duration-300">→</span>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <section className="py-24 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-20">
          ...
          <h2 className="text-6xl font-bold text-white mb-6 tracking-tight luxury-text-reveal">PHU KIỆN XÌ GÀ</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
          {[
            ...
            return (
              <div
                key={index}
                className={`group relative bg-gradient-to-b from-white to-gray-50 border border-amber-500/20 rounded-2xl overflow-hidden hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 text-center premium-card-entrance category-stagger-${index + 1} premium-hover`}
              >
                {/* Premium Badge */}
    ...
    {/* Banner 2 Section - ATELIER HAUTE CREATION */}
    <section className="relative w-full h-[70vh] overflow-hidden">
      ...
      {/* Floating Elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-6 h-6 bg-amber-400/30 rounded-full floating-smoke floating-smoke-1"></div>
        <div className="absolute bottom-32 right-32 w-4 h-4 bg-amber-500/20 rounded-full floating-smoke floating-smoke-3"></div>
        <div className="absolute top-1/2 left-10 w-2 h-2 bg-amber-300 rounded-full golden-particles particle-2"></div>
        <div className="absolute bottom-20 left-1/3 w-3 h-3 bg-amber-400 rounded-full golden-particles particle-4"></div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="text-center text-white max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-6xl font-bold mb-6 tracking-wide luxury-text-reveal cigar-glow">
            ATELIER HAUTE CRÉATION
          </h2>

          <p className="text-2xl font-light mb-8 text-amber-300 animate-fade-in-up animation-delay-400 luxury-shimmer">
            Nghệ thuật chế tác xì gà đỉnh cao
          </p>

          <p className="text-lg mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-600 text-gray-200">
            Khám phá những tác phẩm nghệ thuật được chế tác bằng tay từ những nghệ nhân hàng đầu thế giới
          </p>

          <div className="flex justify-center space-x-6 animate-fade-in-up animation-delay-800">
            <button className="btn-luxury text-black px-10 py-4 rounded-full font-bold text-lg transition-all duration-500 transform hover:scale-110 shadow-2xl">
          ...
          <div className="absolute -bottom-16 left-1/2 transform -translate-x-1/2 opacity-40">
            <div className="flex space-x-6">
              ...
              <GiCigar className="text-3xl text-amber-400 cigar-ring" style={{animationDelay: '10s'}} />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-3xl p-12 mb-16 border border-amber-500/20 shadow-2xl testimonial-float premium-hover cigar-glow">
            ...
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 animate-fade-in-up">
              <div className="flex space-x-1">
                {[...Array(5)].map((_, i) => (
                  <FaStar key={i} className={`text-amber-400 text-2xl animate-fade-in-up animation-delay-${(i + 1) * 200}`} />
                ))}
              </div>
            </div>
            ...
            <div className="text-center space-y-8">
              <p className="text-2xl text-gray-100 leading-relaxed font-light italic luxury-text-reveal animation-delay-200">
                "Chuyên gia chính thức đầu tiên ở Việt Nam hoạt động bởi Golden Phoenix và Avanti,
                một nhà phân phối chính của The Pacific Cigar và Habanos S.A. ở Việt Nam."
              </p>
              <p className="text-xl text-gray-300 leading-relaxed animate-fade-in-up animation-delay-400">
                "Habanos Specialist có nhiều Xì gà Cuba hoàn hảo được ủy lưu từ 24/7 chuyên nghiệp,
                để đảm bảo các điều kiện tối ưu chính xác cho người yêu thích hút xì gà."
              </p>
              ...
              <div className="flex items-center justify-center space-x-6 pt-8 border-t border-amber-500/30 animate-fade-in-up animation-delay-600">
                ...
                <div className="text-left">
                  <div className="text-amber-400 font-bold text-2xl luxury-shimmer">Mr Joel</div>
                  <div className="text-gray-400">Chuyên gia Habanos</div>
                  <div className="flex mt-2 items-center">
                    <FaShieldAlt className="text-amber-500 mr-2 cigar-ring" />
                    <span className="text-sm text-gray-300">Chứng nhận chính thức</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="group relative bg-gradient-to-br from-amber-900/20 to-black/50 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/20 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:scale-105 premium-card-entrance animation-delay-200 premium-hover cigar-glow">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Chính Hãng 100%</h3>
              <p className="text-gray-300">Nhà phân phối chính thức của Habanos S.A. tại Việt Nam với đầy đủ giấy tờ chứng nhận</p>
            ...
            <div className="group relative bg-gradient-to-br from-amber-900/20 to-black/50 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/20 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:scale-105 premium-card-entrance animation-delay-400 premium-hover cigar-glow">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 luxury-shimmer">Chất Lượng Đỉnh Cao</h3>
              <p className="text-gray-300">Điều kiện bảo quản hoàn hảo 24/7 với công nghệ humidor hiện đại nhất</p>
              <div className="mt-6 w-full h-1 bg-gradient-to-r from-amber-500 to-transparent rounded-full whisky-pour"></div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-amber-900/20 to-black/50 backdrop-blur-sm rounded-2xl p-8 border border-amber-500/20 hover:border-amber-500/50 transition-all duration-300 hover:transform hover:scale-105 premium-card-entrance animation-delay-600 premium-hover cigar-glow">
              ...
              <h3 className="text-2xl font-bold text-white mb-4 luxury-text-reveal">Dịch Vụ Hoàng Gia</h3>
              <p className="text-gray-300">Tư vấn cá nhân từ các chuyên gia hàng đầu với kinh nghiệm 20+ năm</p>
              <div className="mt-6 w-full h-1 bg-gradient-to-r from-amber-500 to-transparent rounded-full whisky-pour animation-delay-800"></div>
            </div>
          </div>

          {/* Blog Section with Elegant Cards */}
          <div className="text-center mb-12">
            <h3 className="text-4xl font-bold text-white mb-4">Bài Viết Đặc Sắc</h3>
            <p className="text-xl text-gray-400">Khám phá thế giới xì gà qua góc nhìn của các chuyên gia</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="group relative rounded-3xl overflow-hidden border border-amber-500/20 hover:border-amber-500/50 transition-all duration-500 premium-card-entrance animation-delay-800 premium-hover">
              <div className="relative h-96">
                ...
                <div className="absolute top-6 left-6">
                  <span className="bg-gradient-to-r from-amber-500 to-amber-600 text-black px-4 py-2 rounded-full text-sm font-bold cigar-glow">FEATURED</span>
                </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="text-gray-300 mb-6 line-clamp-2">Khám phá lịch sử và giá trị sưu tập của những chiếc gạt tàn xì gà Cuba đích thực</p>
            ...
            <div className="group relative rounded-3xl overflow-hidden border border-amber-500/20 hover:border-amber-500/50 transition-all duration-500 premium-card-entrance animation-delay-1000 premium-hover">
              <div className="relative h-96">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/30 to-transparent luxury-shimmer"></div>
                <div className="absolute top-6 left-6">
                  <span className="bg-gradient-to-r from-amber-500 to-amber-600 text-black px-4 py-2 rounded-full text-sm font-bold cigar-glow">REVIEW</span>
                </div>
                {/* Golden Particles */}
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="text-gray-300 mb-6 line-clamp-2">Đánh giá chi tiết những phụ kiện cao cấp không thể thiếu cho người sành xì gà</p>
                <button className="group/btn btn-luxury text-black px-8 py-3 rounded-full font-bold transition-all duration-300 transform group-hover:scale-105">
                  Đọc Review
                  <span className="ml-2 group-hover/btn:translate-x-1 transition-transform duration-300">→</span>
                </button>
    ...
    <section className="py-24 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-20">
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-6 tracking-tight luxury-text-reveal">Nhãn Hiệu Danh Tiếng</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 max-w-6xl mx-auto">
          {[
            ...
            return (
              <div
                key={index}
                className={`group text-center cursor-pointer premium-card-entrance category-stagger-${index + 1} relative`}
              >
                {/* Brand Card */}
                <div className="relative bg-white p-8 rounded-2xl shadow-lg border border-gray-200 hover:border-amber-500/50 hover:shadow-2xl hover:shadow-amber-500/20 transition-all duration-500 premium-hover">
                  {/* Icon */}
                  <div className="relative mb-6">
                    <IconComponent className="text-5xl text-gray-400 group-hover:text-amber-600 mx-auto transition-all duration-500 transform group-hover:scale-125 cigar-glow" />

                    {/* Floating Particles */}
                    <div className="absolute -top-2 -right-2 w-2 h-2 bg-amber-400 rounded-full opacity-0 group-hover:opacity-100 golden-particles particle-1 transition-opacity duration-500"></div>
                  </div>

                  {/* Brand Name */}
                  <div className="space-y-2">
                    <h3 className="text-lg font-bold text-gray-700 group-hover:text-amber-600 transition-colors duration-300 luxury-text-reveal">
                      {brand.name}
                    </h3>
                    <div className="w-12 h-px bg-gray-300 group-hover:bg-amber-500 mx-auto transition-colors duration-500 whisky-pour"></div>
                  </div>
                ...
                {/* Decorative Ring */}
                <div className="absolute -top-4 -right-4 w-8 h-8 border border-amber-500/30 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 cigar-ring"></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="text-center mt-16 animate-fade-in-up animation-delay-1000">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-8 border border-gray-200">
            <p className="text-lg text-gray-700 font-medium leading-relaxed">
              "Là đối tác chính thức của những thương hiệu xì gà danh tiếng, chúng tôi cam kết mang đến những sản phẩm chính hãng với chất lượng vượt trội."
            </p>
            <div className="flex items-center justify-center mt-6 space-x-4">
              ...
              <span className="text-amber-600 font-bold">Chứng nhận chính thức</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="relative w-full h-[80vh] overflow-hidden">
      ...
      {/* Floating Whisky Drops */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-32 left-32 w-3 h-3 bg-amber-600 rounded-full golden-particles particle-1"></div>
        <div className="absolute top-48 right-40 w-2 h-2 bg-amber-500 rounded-full golden-particles particle-3"></div>
        <div className="absolute bottom-40 left-1/4 w-4 h-4 bg-amber-400 rounded-full golden-particles particle-5"></div>
        <div className="absolute bottom-24 right-1/3 w-2 h-2 bg-amber-600 rounded-full golden-particles particle-2"></div>
      </div>

      {/* Content Overlay */}
      <div className="absolute inset-0 flex items-end justify-center pb-20">
        <div className="text-center text-white max-w-5xl mx-auto px-4">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-amber-600 to-amber-700 rounded-full mb-8 cigar-glow animate-fade-in-up">
            <div className="text-2xl text-black font-bold">🥃</div>
          </div>

          <h2 className="text-7xl font-bold mb-6 tracking-wide luxury-text-reveal cigar-glow">
            WHISKY & CIGAR
          </h2>

          <h3 className="text-3xl font-light mb-8 text-amber-300 animate-fade-in-up animation-delay-400 luxury-shimmer">
            Bộ Sưu Tập Hoàn Hảo
          </h3>

          <p className="text-xl mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-600 text-gray-200">
            Sự kết hợp tuyệt vời giữa whisky thượng hạng và xì gà Cuba chính hãng - Trải nghiệm đẳng cấp cho những người sành điệu
          </p>

          <div className="flex justify-center space-x-8 animate-fade-in-up animation-delay-800">
            <button className="btn-luxury text-black px-12 py-5 rounded-full font-bold text-xl transition-all duration-500 transform hover:scale-110 shadow-2xl">
              <span className="relative z-10">Khám Phá Bộ Sưu Tập</span>
            </button>
            <button className="border-3 border-amber-400 text-white px-12 py-5 rounded-full font-bold text-xl hover:bg-amber-400 hover:text-black transition-all duration-500 transform hover:scale-110 premium-hover">
              Tư Vấn Pairing
            </button>
          </div>
        </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-center space-x-3 p-4 bg-amber-50 rounded-xl">
                    ...
                    <a href="tel:0975224557" className="text-xl font-bold text-amber-600 hover:text-amber-700 transition-colors">
                      0975224557
                    </a>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-gray-200">
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Giờ mở cửa: <strong>9:00 - 22:00</strong> (Tất cả các ngày trong tuần)
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-200 premium-hover">
              ...
              <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-bold text-gray-900">BH Luxury Cigar</span>
                </div>
              </div>
            </div>
          </div>
