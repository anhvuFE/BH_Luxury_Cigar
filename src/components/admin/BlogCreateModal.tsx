...
const BlogCreateModal: React.FC<BlogCreateModalProps> = ({ isOpen, onClose, onSuccess }) => {
        ...
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full">
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 border-b">
            <div className="flex items-center justify-between">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Tạo bài viết mới</h3>
              <button
                onClick={onClose}
